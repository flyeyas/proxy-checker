...
from proxy_forge.services.auto_run_service import (
    build_auto_log_entry,
    build_auto_runtime,
    build_auto_summary,
    build_failed_auto_runtime,
)
from proxy_forge.services.auto_scheduler_service import interrupt_auto_state, resolve_schedule_state
from proxy_forge.utils import normalize_proxy_list, sanitize_token
