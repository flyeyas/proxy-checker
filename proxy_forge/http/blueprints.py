from proxy_forge.http.auth_routes import create_auth_blueprint
from proxy_forge.http.auto_routes import create_auto_blueprint
from proxy_forge.http.check_routes import create_check_blueprint
from proxy_forge.http.fetch_routes import create_fetch_blueprint
from proxy_forge.http.log_routes import create_log_blueprint
from proxy_forge.http.repo_routes import create_repo_blueprint
from proxy_forge.http.settings_routes import create_settings_blueprint
from proxy_forge.http.static_routes import create_static_blueprint
